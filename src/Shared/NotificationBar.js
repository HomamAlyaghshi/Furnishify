    ...
    isVisible && (
      <div className="relative h-[40px]  bg-yellow-100 flex justify-center items-center gap-[12px] animate-pulse ">
        ...
        <div className="hidden sm:flex items-center ">
          <button className="flex items-center text-blue hover:text-black hover:border-black font-semibold border-b-2 border-blue whitespace-nowrap hover:text-darkBlue hover:border-darkBlue">
            Shop Now
